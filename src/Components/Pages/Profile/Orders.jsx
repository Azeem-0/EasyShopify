    ...
    return <div id="slid-up">
        <motion.div
            ...
            <div id='slid-up-details'>
                ...
                {(!cancel && !deliver) && <form name={id} data-orderid={orderId} data-price={price} data-pattern="orders" data-quantity={quantity} onSubmit={((e) => {
                    ToggleSlid();
                    removeProduct(e);
                })}>
...
function Orders(props) {
    ...
    const ToggleSlid = (e) => {
        if (e) {
            const { name } = e.target;
            const { heading, quantity, price, odate, imageurl, address, description, ddate, cancelled, delivered, orderid } = e.target.dataset;
            setSlidUpDetails({ id: name, orderId: orderid, quantity: quantity, price: price, oDate: odate, heading: heading, imageUrl: imageurl, address: address, description: description, dDate: ddate, cancelled: cancelled, delivered: delivered });
            setSlidUp(!slidUp);
        }
    }
